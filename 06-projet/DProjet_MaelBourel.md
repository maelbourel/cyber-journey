...
| Partage de fichiers | **Nextcloud** / **TrueNas** | Seafile, Pydio Cells | Écosystème applicatif très riche, intégration LDAP/OIDC native, très répandu en entreprise, applications mobiles matures. Seafile est plus performant en transfert pur mais moins intégré. |
